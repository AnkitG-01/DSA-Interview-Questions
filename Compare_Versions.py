...
ignoring any leading zeros. This means that revisions 1 and 001 are considered equal. If a version number does not specify 
a revision at an index, then treat the revision as 0. For example, version 1.0 is less than version 1.1 because their 
...
class Solution:
    def compareVersion(self, version1: str, version2: str) -> int:
        ...
        for rev1,rev2 in zip_longest(ver1,ver2,fillvalue=0):
            if rev1<rev2:
                return -1
            elif rev1>rev2:
                return 1
